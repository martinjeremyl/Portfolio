    ...
    {styles => (
      <animated.div style={{
        ...
        <TravelDetailEditMenuItem onClick={closeEditTravelMenu}>
          <FontAwesomeIcon style={{ width: 50, height: 50 }} icon={['fal', 'info-circle']} />
          <div>
            Modifier les infos du voyage
          </div>
        </TravelDetailEditMenuItem>
        <TravelDetailEditMenuItem onClick={closeEditTravelMenu}>
          <FontAwesomeIcon style={{ width: 50, height: 50 }} icon={['fal', 'users']} />
          <div>
            Ajouter des participants
          </div>
        </TravelDetailEditMenuItem>
        <TravelDetailEditMenuItem onClick={closeEditTravelMenu}>
          <FontAwesomeIcon style={{ width: 50, height: 50 }} icon={['fal', 'cogs']} />
          <div>
